...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\DR GRACE OJO\django_project_two\simple_django_project_two'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\DR GRACE OJO\django_project_two\simple_django_project_two\Scripts\deactivate.nu'
